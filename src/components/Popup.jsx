            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='mb-3'>
                ...
                <div className='mt-2 flex '>
                  ...
                  <input onChange={() => setVille("fianarantsoa")} checked={ville === "fianarantsoa"} type="radio" name="ville" id="ville1" className='pr-2' />
                    <label className='text-white ml-2 capitalize' htmlFor="">fianarantsoa</label>
                  </div>
                </div>
              </div>
              ...
              <div className='mb-3'>
                ...
                <div className='flex items-center'>
                  <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.75 2V3.5M9 2V3.5M5.25 2V3.5M6 11.75H9M6 8H12M2.625 12.5V7.25C2.625 5.129 2.625 4.06775 3.28425 3.40925C3.94275 2.75 5.004 2.75 7.125 2.75H10.875C12.996 2.75 14.0573 2.75 14.7158 3.40925C15.375 4.06775 15.375 5.129 15.375 7.25V9.5C15.375 13.0355 15.375 14.8032 14.2762 15.9012C13.179 17 11.4113 17 7.875 17H7.125C5.004 17 3.94275 17 3.28425 16.3408C2.625 15.6823 2.625 14.621 2.625 12.5Z" stroke="white" stroke-width="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M15.375 11.375C15.375 11.6212 15.3265 11.865 15.2323 12.0925C15.138 12.32 14.9999 12.5267 14.8258 12.7008C14.6517 12.8749 14.445 13.013 14.2175 13.1073C13.99 13.2015 13.7462 13.25 13.5 13.25C13.125 13.25 12.684 13.1847 12.3203 13.2822C12.1613 13.3248 12.0163 13.4085 11.8999 13.5249C11.7835 13.6413 11.6998 13.7863 11.6573 13.9453C11.5598 14.309 11.625 14.7507 11.625 15.125C11.625 15.6223 11.4275 16.0992 11.0758 16.4508C10.7242 16.8025 10.2473 17 9.75 17" stroke="white" stroke-width="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>

                  <label className='text-white capitalize font-DMMono pl-3' htmlFor=""> Votre attente</label>
                </div>
                ...
                <div className='mt-2 grid grid-cols-1 md:grid-cols-3 gap-4'>
                  ...
                  <div className={`border ${isChecked?"border-yellow":"border-raven"} bg-ebony w-full h-[50px] rounded-md pl-3 focus:border-none placeholder:font-DMMono text-white flex items-center`}>
                    ...
                    checked={attend==="reseautage"}
                     ...
                     />
                    <label className='text-white capitalize' htmlFor="option1">Le reseautage</label>
                  </div>

                  <div className={`border ${isChecked?"border-yellow":"border-raven"} bg-ebony w-full h-[50px] rounded-md pl-3 focus:border-none placeholder:font-DMMono text-white flex items-center`}>
                    <input onChange={() => setAttente("confrence")}checked={attend==="confrence"}
                      type="radio"
                      name="confrence"
                      id="confrence"
                      className={`${isChecked} ? 'border-yellow' : 'border-raven' mr-2`}
                     />
                    <label className='text-white capitalize' htmlFor="option2">Les conférence</label>
                  </div>

                  <div className={`border ${isChecked?"border-yellow":"border-raven"} bg-ebony w-full h-[50px] rounded-md pl-3 focus:border-none placeholder:font-DMMono text-white flex items-center`}>
                  <input 
                    onChange={() => setAttente("competition")}checked={attend==="competition"}
                     type="radio"
                     name="competition"
                     id="competition"
                     className={`${isChecked ? 'border-yellow' : 'border-raven'} mr-2`}
                     />
                    <label className='text-white capitalize' htmlFor="option3">La compétition</label>
                  </div>

                  <div className={`md:col-span-3 border ${isChecked ?"border-yellow":"border-raven"} bg-ebony w-full h-[50px] rounded-md pl-3 focus:border-none placeholder:font-DMMono text-white flex items-center`}>
                    <input 
                    ...
                    name="autre" id="autre"
                     className={`${isChecked ? 'border-yellow' : 'border-raven'} mr-2`} />
                    <label className='text-white capitalize' htmlFor="option4">Autre</label>
                  </div>
