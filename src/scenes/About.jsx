            ...
            <div className='w-full h-[90vh] relative'>
                ...
                <div className='w-full h-full bg-[#020f13c9] absolute flex justify-center items-center'>
                    <div className='w-[75%] m-auto '>
                        ...
                        <div className=' font-DMMono md:text-[42px] text-[22px]  leading-[30px] md:leading-[60px] text-center font-semibold text-slate-200'>Cette édition est une tribune dédiée à l'utilisation quotidienne de Linux et à son impact dans tous les domaines.</div>
                    </div>
                </div>
            </div>
            <div className='w-full h-[90vh] relative'>
