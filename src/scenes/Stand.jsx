...
function Stand() {
  return (
    <section >
        ...
        <h2 className='font-kontes  text-white  text-[34px] md:text-[48px] pt-5 pb-5  pl-2'>Démarquez-vous avec un <span className='text-yellow'>stand</span> a votre image.</h2> 
